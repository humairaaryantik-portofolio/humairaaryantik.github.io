...
CREATE TABLE product (
	...
	product_name VARCHAR(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL, /*COLLATE utf8mb4 : Supaya huruf besar dan kecil dianggap sama saat dibandingkan*/
	price DECIMAL(15,2) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci; /*COLLATE utf8mb4 : Supaya bisa menyimpan semua jenis tulisan dan emoji*/
DESC product;
...
CREATE TABLE purchase(
  ...
  pruchase_timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP /*TIMESTAMP : Tipe data tanggal dan waktu, DEFAULT CURRENT_TIMESTAMP : otomatis menyimpan waktu saat data dibuat*/
...
CREATE TABLE user (
  id INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, /*INT UNSIGNED : tidak bisa negatif dan batas menjadi 2 kali lipat*/
  first_name VARCHAR(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  last_name VARCHAR(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  email VARCHAR(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  fk_user_role INT DEFAULT NULL,
  money DECIMAL(15,2) DEFAULT '0.00', /*Jika tidak diisi, otomatis bernilai 0.00*/
  credit_card VARCHAR(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  UNIQUE KEY email_UNIQUE (email),
  KEY role_id_idx (fk_user_role), /*Membuat index pada kolom fk_user_role agar proses pencarian/join lebih cepat.*/
